...
interface FirestoreService {
    ...
    /** Get documents filtered by a field value (one-shot). */
    suspend fun getCollection(collectionPath: String, whereField: String, equalsValue: String): List<Map<String, Any?>>
